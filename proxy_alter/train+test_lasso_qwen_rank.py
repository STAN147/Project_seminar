...
print(f"Спирмен на SIQA + Qwen: {spearman_corr_siqa:.3f} (p-value: {p_value_siqa:.3f})")
...
Результаты проверки на SIQA
Спирмен на SIQA + Phi-Tiny: 0.761 (p-value: 0.000)
Спирмен на SIQA + Qwen: 0.913 (p-value: 0.000)'''