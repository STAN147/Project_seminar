...
y_train_ranks = rankdata(y_train)
...
lasso_model.fit(x_train_scaled_df, y_train_ranks)
...
'''
Cosine_Dist_std      0.305757
Cosine_Dist_first    0.270302
Cosine_Dist_last    -0.242292
Var_Ratio_prev       0.122061
L_Inf_next           0.048624
Pearson_last         0.010962
Pearson_first       -0.000001
dtype: float64

Спирмен на Qwen + Commonsense: 0.8061
Спирмен на Phi-Tiny + Commonsense: 0.8717
Спирмен на Qwen + SIQA: 0.9132
Спирмен на Phi-Tiny + SIQA: 0.7609
'''